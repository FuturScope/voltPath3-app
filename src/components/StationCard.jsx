...
const StationCard = ({ station }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md flex flex-col justify-between  duration-300 max-w-md mx-auto sm:m-4">
      <div>
        <img
        ...
        <div className="flex items-center text-sm text-gray-600 font-bold mt-2 mb-2">
          <span>Reviews:</span>
        ...
        <p className="text-gray-600 text-sm mb-2">
          <span className="font-bold">Power Output:</span> {station.powerOutput}
        </p>
        <p className="text-gray-600 text-sm mb-2">
